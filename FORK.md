...
read from disk on every reload, all written for upstream and leaving at the first upstream commit that carries them. The fifth carried commit, the e2e warm step's absolute `-toolexec` path, changes no behaviour
